...
-- joining two copies of the stops table we can refer to stops by name rather
-- than by number. Change the query so that the services between 'Craiglockhart' and 'London Road' are shown.
